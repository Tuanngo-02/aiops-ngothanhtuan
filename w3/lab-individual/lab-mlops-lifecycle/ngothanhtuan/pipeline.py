"""
pipeline.py — Train IsolationForest trên baseline data với Pipeline chuẩn hóa, log vào MLflow, register model.
...
def train(
    ...
    # Đóng gói StandardScaler và IsolationForest vào Pipeline để chuẩn hóa tự động trong inference
    ...
    # Lấy nhãn dự đoán để tính toán anomaly rate: -1 = anomaly, 1 = normal
    ...
    with mlflow.start_run() as run:
        ...
        # Log scaler riêng biệt dưới dạng artifact để duy trì tính tương thích ngược
    ...
    # Set alias 'production' cho phiên bản mới nhất
