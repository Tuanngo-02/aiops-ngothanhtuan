...
![Pipeline](../resource/pipeline-sys.png)
...
├──thanh-tuan-ngo/
    ...
    ├── engine.py                 (optional starting skeleton — feel free to ignore)
    ├──features.py (featuring vector logs, metrics, traces )
    ├──retrieval.py (similarity and outcome-weighted voting)
    ├──decision.py (Select the best action candidate)
